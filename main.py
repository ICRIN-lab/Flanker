...
dataFile = open('Flanker/Flankercsv/' + fileName + '.csv', 'w')  # a simple text file with 'comma-separated-values'
dataFile.write('no_trial, id_candidate, good_ans, ans_candidate, keyboard_pressed, '
               'correct, practice, reaction_time, time_stamp\n')
